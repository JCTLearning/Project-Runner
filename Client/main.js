...
const createLogin = () => {
  mainWindow = new BrowserWindow({width: 1000, height: 600, icon: __dirname + '/programIcon.png'})
...
ipcMain.on('loginSuccess', (event, userDatas) => {
  //console.log(userData); We're just putting in the user url here.
  userData = userDatas
